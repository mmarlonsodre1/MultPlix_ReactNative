...
import {Text, View, Image, StyleSheet, FlatList, TouchableOpacity, ActivityIndicator, Modal} from 'react-native';
    ...
    const submitSearch = async () =>  { 
        if (searchText != '') {
            try {
                ...
                if (response.data != null) setTextResult('Resultado da Busca');
                setIsLoading(false);
            } catch (error) {}
        }
    }
